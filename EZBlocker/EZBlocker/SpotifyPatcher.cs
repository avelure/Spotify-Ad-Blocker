...
namespace EZBlocker
{
    class SpotifyPatcher
    {
        ...
        public bool Patch()
        {
            ...
            string worker = @"var _p;var sendEZB=function(e){if (_p === e) return;_p = e;var t=new XMLHttpRequest;t.open('GET','http://localhost:19691/'+e,!0),t.send()};self.addEventListener('message',function(e){sendEZB(e.data),setTimeout(function(){postMessage('ready')},300)},!1);";
